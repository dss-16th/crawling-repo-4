...
### 1-3 팀원 / 역할
- [이지홍](https://github.com/***) 코로나 확진자, 거리두기, 백신 현황 데이터 크롤링, mongodb 관리, 카카오 api를 통한 메세지 전송 기능 구현, 메세지 내 웹 서버 링크 연동, 리드미 작성 
- [이경무](https://github.com/rudan916) 백신, 사회적거리두기, 재난지원금, 확진 이슈 키워드별 검색결과 데이터 크롤링, mongodb 관리, Flask를 통한 웹 서버 배포, DB와 웹 연동, 리드미 작성
